...
public class AI_State_Alert_GuardSound : StateMachineBehaviour {
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        Vector2 lastHeardSoundPos = memoryCache[0].lastSeenPosition;
        orient.lookAtStep(lastHeardSoundPos);
    }
